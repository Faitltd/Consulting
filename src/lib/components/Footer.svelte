<footer class="footer">
  <div class="container footer-grid">
    <div class="brand">
      ...
      <a
        class="inline-link"
        href="mailto:admin@itsfait.com?subject=30-Minute%20Consultation%20Request"
      >
        Book a consultation
      </a>
    </div>
    ...
    <div>
      ...
      <nav class="link-list">
        ...
        <a href="/services/waste-analysis">Waste Analysis</a>
        <a href="/services/business-optimization">Business Optimization</a>
      </nav>
    </div>
  ...
  <div class="container footer-bottom">
    <span>(c) 2025 FAIT Consulting. All rights reserved.</span>
