export type Service = {
  slug: 'process-automation' | 'waste-analysis' | 'business-optimization';
  name: string;
  summary: string;
  heroTitle: string;
  heroLead: string;
...
export const services: Service[] = [
  {
    ...
    heroLead:
      'We design, document, and automate your core workflows so your team stops chasing status and starts shipping work.',
  ...
  },
  {
    ...
    heroLead:
      'We align pricing, capacity, and delivery with a clear playbook so projects stay profitable and clients get consistent outcomes.',
