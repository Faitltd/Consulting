...
type LayoutRouteId = RouteId | "/" | "/about" | "/case-studies" | "/case-studies/[slug]" | "/contact" | "/legal/privacy-policy" | "/legal/terms" | "/resources" | "/resources/[slug]" | "/services" | "/services/business-optimization" | "/services/process-automation" | "/services/waste-analysis" | null
